...
struct qt_meta_stringdata_GasGaugePlugin_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_GasGaugePlugin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GasGaugePlugin_t qt_meta_stringdata_GasGaugePlugin = {
    {
QT_MOC_LITERAL(0, 0, 14) // "GasGaugePlugin"
...
static const uint qt_meta_data_GasGaugePlugin[] = {
...
QT_INIT_METAOBJECT const QMetaObject GasGaugePlugin::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_GasGaugePlugin.data,
    qt_meta_data_GasGaugePlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *GasGaugePlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GasGaugePlugin.stringdata0))
