...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = './gasman.data';
      var REMOTE_PACKAGE_BASE = 'gasman.data';
          ...
          DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_./gasman.data');

      };
      Module['addRunDependency']('datafile_./gasman.data');
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5894944,
    DYNAMIC_BASE = 11137824,
    DYNAMICTOP_PTR = 5894000;
...
var wasmBinaryFile = 'gasman.wasm';
...
var ASM_CONSTS = {
  5582290: function() {throw 'Canceled!'}
};
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=5894928;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 5894176;
        ...
        Atomics.store(HEAPU32, (PThread.mainThreadBlock + 44 ) >> 2, PROCINFO.pid); // Process ID.
        ...
        var pthreadMainJs = locateFile('gasman.worker.js');
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(32, 1, name_);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(35, 1, target);
  ...
  var _fetch_work_queue=5894160;function __emscripten_get_fetch_work_queue() {
  ...
  function _emscripten_syscall(which, varargs) {
    switch (which) {
      ...
      case 15: return ___syscall15(which, varargs);
      ...
      case 193: return ___syscall193(which, varargs);
      ...
      case 199: return ___syscall199(which, varargs);
      case 20: return ___syscall20(which, varargs);
      case 201: return ___syscall201(which, varargs);
      ...
      case 320: return ___syscall320(which, varargs);
      ...
      case 83: return ___syscall83(which, varargs);
      case 85: return ___syscall85(which, varargs);
      case 9: return ___syscall9(which, varargs);
      case 91: return ___syscall91(which, varargs);
      case 94: return ___syscall94(which, varargs);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(49, 1, contextHandle);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(52, 1, fd, offset_low, offset_high, whence, newOffset);
  try {
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(53, 1, fd);
  try {
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 5894064, 4), 5894064);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(57, 1, fildes, name);
  ...
  function __spawn_thread(threadParams) {
      ...
      Atomics.store(HEAPU32, tis + (44 >> 2), PROCINFO.pid); // Process ID.
...
var proxiedFunctionTable = [null,_atexit,___syscall10,___syscall102,___syscall122,___syscall15,___syscall168,___syscall183,___syscall192,___syscall193,___syscall194,___syscall195,___syscall196,___syscall197,___syscall202,___syscall20,___syscall220,___syscall221,___syscall3,___syscall320,___syscall33,___syscall38,___syscall39,___syscall4,___syscall40,___syscall5,___syscall54,___syscall83,___syscall85,___syscall9,___syscall91,___syscall94,_eglGetProcAddress,_emscripten_force_exit,_emscripten_get_element_css_size,_emscripten_is_webgl_context_lost,_emscripten_set_canvas_element_size_main_thread,_emscripten_set_focus_callback_on_thread,_emscripten_set_keydown_callback_on_thread,_emscripten_set_keyup_callback_on_thread,_emscripten_set_mousedown_callback_on_thread,_emscripten_set_mousemove_callback_on_thread,_emscripten_set_mouseup_callback_on_thread,_emscripten_set_resize_callback_on_thread,_emscripten_set_touchcancel_callback_on_thread,_emscripten_set_touchend_callback_on_thread,_emscripten_set_touchmove_callback_on_thread,_emscripten_set_touchstart_callback_on_thread,_emscripten_set_wheel_callback_on_thread,_emscripten_webgl_destroy_context_main_thread,_fd_close,_fd_fdstat_get,_fd_seek,_fd_sync,_fd_write,_getaddrinfo,_tzset,_fpathconf,_sysconf];
...
if (!Object.getOwnPropertyDescriptor(Module, "PThread__postset")) Module["PThread__postset"] = function() { abort("'PThread__postset' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "PThread__deps")) Module["PThread__deps"] = function() { abort("'PThread__deps' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
Module["PThread"] = PThread;
if (!Object.getOwnPropertyDescriptor(Module, "establishStackSpaceInJsModule")) Module["establishStackSpaceInJsModule"] = function() { abort("'establishStackSpaceInJsModule' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
...
if (!Object.getOwnPropertyDescriptor(Module, "PThread__postset__deps")) Module["PThread__postset__deps"] = function() { abort("'PThread__postset__deps' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "establishStackSpaceInJsModule__deps")) Module["establishStackSpaceInJsModule__deps"] = function() { abort("'establishStackSpaceInJsModule__deps' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "getNoExitRuntime__deps")) Module["getNoExitRuntime__deps"] = function() { abort("'getNoExitRuntime__deps' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
...
Module["wasmMemory"] = wasmMemory;if (!Object.getOwnPropertyDescriptor(Module, "ALLOC_NORMAL")) Object.defineProperty(Module, "ALLOC_NORMAL", { configurable: true, get: function() { abort("'ALLOC_NORMAL' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") } });
