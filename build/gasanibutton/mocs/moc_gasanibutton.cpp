...
struct qt_meta_stringdata_GasAniButton_t {
    QByteArrayData data[3];
    char stringdata0[33];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_GasAniButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GasAniButton_t qt_meta_stringdata_GasAniButton = {
    {
QT_MOC_LITERAL(0, 0, 12), // "GasAniButton"
QT_MOC_LITERAL(1, 13, 10), // "DownPixmap"
QT_MOC_LITERAL(2, 24, 8) // "UpPixmap"

    },
    "GasAniButton\0DownPixmap\0UpPixmap"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_GasAniButton[] = {
 ...
 // properties: name, type, flags
       1, QMetaType::QPixmap, 0x00095003,
       2, QMetaType::QPixmap, 0x00095003,
...
QT_INIT_METAOBJECT const QMetaObject GasAniButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractButton::staticMetaObject>(),
    qt_meta_stringdata_GasAniButton.data,
    qt_meta_data_GasAniButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *GasAniButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GasAniButton.stringdata0))
