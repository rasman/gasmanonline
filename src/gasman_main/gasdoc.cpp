...
//
// Legacy path (#ifdef EULAR — not compiled, retained for reference only):
//   Computes fdtOverEffectiveVolume for the old Euler forward-difference method.
...
//
// Legacy Euler path (#ifdef EULAR — not compiled, retained for reference only).
//
